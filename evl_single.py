...
from atthis.models import GAANet
from atthis.datas.transform import get_preprocessing_pipelines
from atthis.videomodels import ResNetVideoModel
...
if __name__ == '__main__':
    ...
    audiomodel = GAANet.from_pretrain(checkpoint_path, sample_rate=train_conf["datamodule"]["data_config"]["sample_rate"], **train_conf["audionet"]["audionet_config"])
